...
/**
 * 80. Remove Duplicates from Sorted Array II Medium Given an integer array nums sorted in
 * non-decreasing order, remove some duplicates in-place such that each unique element appears at
 ...
 * not matter what you leave beyond the returned k (hence they are underscores). Example 2:
 *
 ...
 * <p>Constraints:
 *
 * <p>1 <= nums.length <= 3 * 104 -104 <= nums[i] <= 104 nums is sorted in non-decreasing order.
 */
public class RemoveDuplicatesFromSortedArrayII {
  public static void main(String[] args) {
    ExecutionMeasure.measureExecutionTime(
        () -> removeDuplicates(new int[] {0, 0, 1, 1, 1, 1, 2, 3, 3}));
    ExecutionMeasure.measureExecutionTime(() -> removeDuplicates(new int[] {1, 2}));
  }
