...
public class GasStation {
    ...
    public static void main(String[] args) {
        ExecutionMeasure.measureExecutionTime( () -> canCompleteCircuit(new int[]{1,2,3,4,5}, new int[]{3,4,5,1,2}));
        ExecutionMeasure.measureExecutionTime("kadane", () -> kadaneCanCompleteCircuit(new int[]{1,2,3,4,5}, new int[]{3,4,5,1,2}));
    }
