...
/**
 * 135. Candy Attempted Hard
 *
 * <p>Topics Companies There are n children standing in a line. Each child is assigned a rating
 ...
 * <p>Example 1:
 *
 * <p>Input: ratings = [1,0,2] Output: 5 Explanation: You can allocate to the first, second and
 * third child with 2, 1, 2 candies respectively. Example 2:
 *
 * <p>Input: ratings = [1,2,2] Output: 4 Explanation: You can allocate to the first, second and
 * third child with 1, 2, 1 candies respectively. The third child gets 1 candy because it satisfies
 * the above two conditions.
 *
 * <p>Constraints:
 *
 * <p>n == ratings.length 1 <= n <= 2 * 104 0 <= ratings[i] <= 2 * 104
 */
public class Candy {
  ...
  static int candy(int[] ratings) {
    ...
    int totalCandies = 0;
    for (int candies : candiesPerKid) totalCandies += candies;
